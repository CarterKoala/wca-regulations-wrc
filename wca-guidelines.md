...
- 11f+) [ADDITION] If a missing signature from a new competitor is found and is not possible to be added(e.g. the competitor has left the venue or the compeition has ended), it may be added retroactive with a support of video evidence at the discretion of the WCA Delegate (see [Guideline A7g++++](guidelines:guideline:A7g++++)).
