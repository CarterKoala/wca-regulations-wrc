...
- 9p2b+) [ADDITION] If there are not enough competitors representing the relevant region to fill the reserved spaces, they are replaced with the top ranked competitors representing any region.
- 9p2b++) [RECOMMENDATION] Any use of reserved spaces for final rounds should be clearly announced before the competition.
