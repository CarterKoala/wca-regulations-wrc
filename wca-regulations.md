...
- E2) Procedure for 3x3x3 Fewest Moves:
    ...
    - E2c) At 60 minutes, each competitor must submit to the judge a single piece of paper with a written solution and information to identify the attempt. The competitor's solution is considered correct if starting with a solved puzzle and applying the scramble sequence followed by the solution results in a solved puzzle. Penalty for an incorrect solution: disqualification of the attempt (DNF).
        ...
        - E2c4) Only numbers, letters, and apostrophes will be considered as part of a competitor’s solution and other symbols will be disregarded. The remaining solution must only use moves that are exactly defined as notation for the 3x3x3 Cube in [Regulation 12a](regulations:regulation:12a). Penalty: disqualification of the attempt (DNF).
        - E2c5) If a competitor incorrectly capitalizes a move that is defined in [Regulation 12a](regulations:regulation:12a), it should be interpreted as if it were correctly capitalized and accepted as valid notation.
        - E2c6) Any writing or other markings on the solution sheet which are clearly not a part of the competitor's intended solution may be disregarded, at the discretion of the judge.
        - E2c7) The competitor's solution is considered correct if starting with a solved puzzle and applying the scramble sequence followed by the solution (after applying any considerations from [E2c4](regulations:regulation:E2c4), [E2c5](regulations:regulation:E2c5), and [E2c6](regulations:regulation:E2c6)) results in a solved puzzle. Penalty for an incorrect solution: disqualification of the attempt (DNF).
