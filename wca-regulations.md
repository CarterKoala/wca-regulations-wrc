...
- A2) Scrambling:
    ...
    - A2e) The judge places the puzzle onto the mat in an arbitrary orientation while ensuring that it remains completely covered.
        ...
        - A2e2) If the compeititor accidently knocked the cover off and the puzzle is partially or fully visible to the competiitor, an extra may be provided instead of disqualification of the attempt (DNF), at the discretion of the WCA Delegate.
- A3) Inspection:
