...
- A2) Scrambling:
    - A2a) When called for a round, the competitor submits the puzzle, in its solved state, to the scrambler. If a Competitor Waiting Area is in use, the competitor then waits in their assigned Competitor Waiting Area until they are called to compete. If a Competitor Waiting Area in not in use, the competitor then waits at their assigned solving station.
    ...
    - A2c) After the scrambler starts scrambling the puzzle, the competitor must not see the puzzle until the inspection phase starts.
        ...
        - A2c2) When competing, competitors must not actively try to watch another competitor complete
an official attempt. If the competitor watches another competitor attempt a scramble they have not yet received, the corresponding attempt is recorded as DNF.
