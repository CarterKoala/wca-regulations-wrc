...
- 9p) If an event has multiple rounds, then:
    ...
    - 9p2) The competitors who advance to the next round must be determined by ranking (best X competitors) or by result (all competitors with a better result than X) in the preceding round.
        ...
        - 9p2b) Exception: For final rounds of a competition designated as a National Championship or Continental Championship, the organization team may reserve spaces for competitors representing the relevant region. A maximum of 8 spaces or 50% of spaces in the final round, whichever is the lower, may be reserved in this way. For a final round with reserved spaces, the competitors advancing from the previous round are a reserved number of best competitors representing the relevant region, followed by the remaining best competitors representing any region.
