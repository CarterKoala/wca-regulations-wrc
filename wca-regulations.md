...
- B4) Blindfolded phase:
    ...
    - B4c) As soon as the competitor applies the first move to the puzzle, the judge must ensure that there is a sight blocker (e.g. a sheet of paper or cardboard) between the competitor's face and the puzzle.
        ...
        - B4c3) If the judge and competitor agree beforehand, the competitor may choose to place the puzzle behind a suitable object (e.g. a music stand, the surface of the table) by themselves during the blindfolded phase. In this case, the competitor must place the object between their face and the puzzle. Penalty: disqualification of the attempt (DNF).
